...
/*   Updated: 2025/12/17 17:49:23 by speters          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	const Animal *shiro = new Dog();
	std::cout << MSG_MAIN << "shiro is a " << shiro->getType() << " 🐶" << RST << std::endl;
	shiro->makeSound();
	delete shiro;
	std::cout << std::endl;
	...
	std::cout << MSG_MAIN << "this apparently is a " << wcat->getType() << RST << std::endl;
	wcat->makeSound();
	delete wcat;
	std::cout << std::endl;
